...
import Props from '../Reference/Props';
...
function Reference(props) {
  ...
  const pages = [
    ...
    { title: 'Props', className: myPage === 2 ? 'selected' : 'unselected', onClick: () => handlePage(2) },
    { title: 'Game Terms', className: myPage === 3 ? 'selected' : 'unselected', onClick: () => handlePage(3) }
  ];
  ...
  return (
    <>
        ...
        <div id='creation'>
            ...
            { myPage === 3 && <Terms gameTerms={props.creation[2].gameTerms}/> }
        </div>
